      ...
      <section className={styles["layout-container"]}>
        <div className={styles["primary-content-container"]}>
          ...
          <p className={styles["description"]}>
            Pneus Premium da linha Dunlop e da linha Strong na medida certa para
            seu veículo, garantindo maior durabilidade e estabilidade nas
            pistas.
          </p>
        ...
        <div className={styles["vantages-container"]}>
          ...
          <section className={styles["vantage"]}>
            <Icon path="cifrao" width={32} height={32} alt="Ícone de cifrão" />
